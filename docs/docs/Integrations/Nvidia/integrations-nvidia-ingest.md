---
title:  Integrate NVIDIA Retriever Extraction with Langinfra
...
* The **NVIDIA Retriever Extraction** component requires the installation of additional dependencies to your Langinfra environment. To install the dependencies in a virtual environment, run the following commands.
