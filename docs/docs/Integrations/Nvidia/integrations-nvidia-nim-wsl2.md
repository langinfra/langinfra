---
title:  Integrate NVIDIA NIMs with Langinfra
slug: /integrations-nvidia-ingest-wsl2
---

Connect **Langinfra** with **NVIDIA NIM** on an RTX Windows system with [Windows Subsystem for Linux 2 (WSL2)](https://learn.microsoft.com/en-us/windows/wsl/install) installed.
...
In this example, you connect a model component in **Langinfra** to a deployed `mistral-nemo-12b-instruct` NIM on an **RTX Windows system** with **WSL2**.
...
To connect the NIM you've deployed with Langinfra, add the **NVIDIA** model component to a flow.
