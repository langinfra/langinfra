...
For an example Langinfra JSON file, examine the [Basic Prompting.json](https://github.com/langinfra/langinfra/blob/main/src/backend/base/langinfra/initial_setup/starter_projects/Basic%20Prompting.json) file in the Langinfra repository.
