...
For example, the [Recursive character text splitter](https://github.com/langinfra/langinfra/blob/main/src/backend/base/langinfra/components/langchain_utilities/recursive_character.py) is a child of the [LCTextSplitterComponent](https://github.com/langinfra/langinfra/blob/main/src/backend/base/langinfra/base/textsplitters/model.py) class.
