...
/**
 * Generates JavaScript code for making API calls to a Langinfra endpoint.
 *
...
if (!process.env.LANGINFRA_API_KEY) {
    throw new Error('LANGINFRA_API_KEY environment variable not found. Please set your API key in the environment variables.');
}
`
      : ""
  }const payload = {
