...
export const GITHUB_URL = "https://github.com/langinfra/langinfra";
export const TWITTER_URL = "https://x.com/langinfra_ai";
export const DOCS_URL = "https://docs.langinfra.org";
