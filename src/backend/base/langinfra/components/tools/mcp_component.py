...
from langinfra.inputs import DropdownInput, TableInput
from langinfra.inputs.inputs import InputTypes
from langinfra.io import MessageTextInput, MultilineInput, Output, TabInput
from langinfra.io.schema import flatten_schema, schema_to_langinfra_inputs
    ...
    def get_inputs_for_all_tools(self, tools: list) -> dict:
        ...
        for tool in tools:
            ...
            try:
                ...
                input_schema = create_input_schema_from_json_schema(flat_schema)
                langinfra_inputs = schema_to_langinfra_inputs(input_schema)
                inputs[tool.name] = langinfra_inputs
