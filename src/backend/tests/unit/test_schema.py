...
import pytest
from langinfra.inputs.inputs import BoolInput, DictInput, FloatInput, InputTypes, IntInput, MessageTextInput
...
def test_schema_to_langinfra_inputs():
    ...
    # Convert schema to Langinfra inputs
    inputs = schema_to_langinfra_inputs(TestSchema)
...
def test_schema_to_langinfra_inputs_invalid_type():
    ...
    with pytest.raises(TypeError, match="Unsupported field type:"):
        schema_to_langinfra_inputs(InvalidSchema)
