...
from langinfra.components.embeddings.embedding_model import EmbeddingModelComponent
...
class TestEmbeddingModelComponent(ComponentTestBaseWithClient):
    ...
    @patch("langinfra.components.embeddings.embedding_model.OpenAIEmbeddings")
