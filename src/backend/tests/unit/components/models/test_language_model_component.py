...
from langinfra.components.models import LanguageModelComponent
...
class TestLanguageModelComponent(ComponentTestBaseWithClient):
    ...
    @patch("langinfra.components.models.language_model.ChatOpenAI")
    ...
    @patch("langinfra.components.models.language_model.ChatAnthropic")
