...
import pytest
from langinfra.components.vectorstores.local_db import LocalDBComponent
from langinfra.schema.data import Data
from langinfra.services.cache.utils import CACHE_DIR
...
class TestLocalDBComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langinfra.components.vectorstores.local_db.LocalDBComponent.list_existing_collections")
