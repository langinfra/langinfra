...
import pytest
from langinfra.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langinfra.components.youtube.youtube_transcripts.YoutubeLoader")
