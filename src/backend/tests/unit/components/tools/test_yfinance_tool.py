...
from langinfra.components.tools import YfinanceComponent
from langinfra.components.tools.yahoo import YahooFinanceMethod
...
class TestYfinanceComponent:
    ...
    @patch("langinfra.components.tools.yahoo.yf.Ticker")
