...
from langinfra.components.tools import SerpComponent
...
@patch("langinfra.components.tools.serp.SerpAPIWrapper")
...
def test_error_handling():
    ...
    with patch("langinfra.components.tools.serp.SerpAPIWrapper") as mock_serpapi:
        mock_instance = MagicMock()
