...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the Langinfra run endpoint.
    ...
    Environment Variables:
      - LANGINFRA_HOST: Base URL for the Langinfra server (default: http://localhost:7860)
    ...
    host = os.getenv("LANGINFRA_HOST", "http://localhost:7860")
    ...
    def run_flow_endpoint(self):
        ...
        payload = {
            "input_value": (
                "Hey, Could you check https://docs.langinfra.org for me? Later, could you calculate 1390 / 192 ?"
            ),
            "output_type": "chat",
            "input_type": "chat",
            "tweaks": {},
